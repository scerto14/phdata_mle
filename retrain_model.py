...
def main():
    ...
    #test split and state changed to test updating (i.e. retraining) base model
    x_train, _x_test, y_train, _y_test = model_selection.train_test_split(
        x, y, random_state=35, test_size=.5)
    ...
    pickle.dump(model, open(output_dir / "model_retrained.pkl", 'wb'))
